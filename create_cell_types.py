...
====================================================================================================
  ...
  --------
    python create_cell_types_tab.py
    python create_cell_types_tab.py cells.xml
  
  Outputs
  -------
    cells_types_tab.py: Python module used to create/edit cell parameters (--> "Cell Types" GUI tab)
